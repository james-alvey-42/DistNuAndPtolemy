    ...
    def update_cosmo_arguments(self):
        ...
        for elem in self.get_mcmc_parameters(['cosmo']):
            ...
            # infer omega_cdm from omega_m (assuming one standard massive neutrino and omega_nu=m_nu/93.14) and delete omega_m
                ...
                self.cosmo_arguments['ncdm_psd_parameters'] = r'%g, %g, %g, %g, %g' % (self.cosmo_arguments[elem], 10**self.cosmo_arguments['logystar'], 10**self.cosmo_arguments['logsigmastar'], self.cosmo_arguments['Tempncdm'], self.cosmo_arguments['Gauss'])
                del self.cosmo_arguments[elem]
            elif elem == 'logystar':
                del self.cosmo_arguments[elem]
            elif elem == 'logsigmastar':
                del self.cosmo_arguments[elem]
            elif elem == 'Tempncdm':
                del self.cosmo_arguments[elem]
            elif elem == 'Gauss':
